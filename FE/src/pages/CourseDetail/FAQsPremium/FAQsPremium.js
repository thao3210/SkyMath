...
function FAQsPremium() {
    ...
    try {
      if (updateIdQuestion) {
        ...
        if (updatedContent) {
          ...
          formData.append("FAQQuestionId", updateIdQuestion);
  ...
  const getFAQs = async () => {
    try {
      const response = await FAQsService.getCourseFAQsByID(id, false);
  ...
  return (
    <div
      ...
      id="v-pills-faqPremium"
      role="tabpanel"
      aria-labelledby="v-pills-faqPremium-tab"
      tabIndex="0"
      style={{ border: "none" }}
    >
      <CustomSnackbar
              ...
              <div className="d-flex ">
                ...
                <div className="flex-grow-1 ms-3 ml-2">
                  <strong className="d-block name">
                    ...
                    >
                      <h5 tag="5">Question</h5>
                    </Link>
                  </strong>

                  <small key={faq.id} className="extra">
                    {faq.lastModifiedDate}
                  </small>
                </div>
              </div>{" "}
            </div>
          </div>
          <div className="card-view-post">
