...
const ListMatchingQuizView = () => {
  ...
  const fetchQuizData = async () => {
    try {
      const response = await MatchingService.getQuiz();
  ...
  const handleDeleteRow = async (id) => {
    try {
      const response = await MatchingService.deleteQuiz(id);
  ...
  const handleEditRow = async (id, updatedData) => {
    try {
      const response = await MatchingService.editQuiz(id, updatedData);
...
export default ListMatchingQuizView;
